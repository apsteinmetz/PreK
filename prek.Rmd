...
##Alternatively, load from csv files the data we would have otherwise gotten from census.gov
```{r}
...
Combine the data and do some per capita and normalization calculations.  To set the stage for the bi-variate plot we need to split the data into bins.  A 3x3 matrix of income cohorts and pre-K seat quantiles is about all we can handle without over-complicating the visual.
