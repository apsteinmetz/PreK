...
This is an exploration comparing income to pre-K seats by neighborhoods. It was done mainly to help me practice with web scraping, document parsing and making cool bi-variate choropleth maps! I had to invent a novel method in R to get good looking bivariate legend onto the chart.
...
#use the 'cowplot' package to create a plot that will be the legend itself
