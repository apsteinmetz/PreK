...
To create the legend we 'simply' create a heat map of the 3x3 bins in the map, label the axes appropriately and save the image.  Then, using `addcontrol(), shove it into a corner of the map.
